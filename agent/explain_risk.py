#!/usr/bin/env python3
"""投资风险与管理层质量评估智能体 CLI 入口。

用法:
    python explain_risk.py 600519
    python explain_risk.py 贵州茅台 --stream
"""
...
from agent.risk_reviewer.graph import compile_app
from agent.tools.data_fetcher import resolve_company


def main() -> int:
    parser = argparse.ArgumentParser(description="投资风险与管理层质量评估智能体")
