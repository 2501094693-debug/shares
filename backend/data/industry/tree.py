...
from data.core.paths import TREE_CACHE, ensure_cache_dirs

_FETCH_RETRIES = 3
_FETCH_RETRY_SLEEP_SEC = 2.0


def _fetch_sw_frames() -> tuple[DataFrame, DataFrame, DataFrame] | None:
...
class IndustryTree:
    ...
    def search(self, keyword: str, limit: int = 500) -> list[dict[str, Any]]:
        """三级行业子串搜索（名称 / 上下级名 / 代码）。"""
        self.get_tree()
