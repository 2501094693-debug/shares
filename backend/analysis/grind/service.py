...
from analysis.grind.screen import apply_view, screen_grind
from analysis.persist import KIND_GRIND, JobSlot, is_fresh, load_disk, save_disk, strip_charts


class GrindScreenService:
    ...
    def run_or_poll(
        ...
        *,
        ...
        packed = load_disk(KIND_GRIND, key) if need_disk else None
    ...
    def _worker(self, key: str, days: int, code: str, workers: int, run_id: int) -> None:
        ...
        try:
            ...
            save_disk(KIND_GRIND, key, result)
