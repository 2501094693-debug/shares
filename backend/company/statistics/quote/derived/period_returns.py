...
区间按交易日近似（不是自然日）。20≈月、60≈季、120≈半年、250≈年。
    ...
    python company/statistics/quote/derived/period_returns.py 600519
    python company/statistics/quote/derived/period_returns.py 000001 --adjust none
    python company/statistics/quote/derived/period_returns.py sh000001
"""
