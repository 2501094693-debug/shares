...
公开查询（JSONP POST，需带官网 Referer）：
  ...
  - 问询函没有独立栏目，用 keyword=问询函 查公司公告
    ...
    python company/news/bse.py 920185
    python company/news/bse.py 920185 --days 90
    python company/news/bse.py 920185 --category annual
    python company/news/bse.py 920185 --keyword 减持
    python company/news/bse.py 920047 --inquiries
    python company/news/bse.py 430047 --layer neeq
    python company/news/bse.py --latest --days 3 --limit 20
    python company/news/bse.py 920185 --download ./pdfs --limit 3
"""
