...
个股请走 F10；``tapp/news/push/stock`` 是全市场快讯，不能按代码检索。
    ...
    python -m company.news.platforms.tonghuashun 600519
    python -m company.news.platforms.tonghuashun 贵州茅台 --days 7
    python -m company.news.platforms.tonghuashun 600519 --notices --days 90
    python -m company.news.platforms.tonghuashun 600519 --notices --classify earnings --limit 5
    python -m company.news.platforms.tonghuashun 600519 --notices --download ./pdfs --limit 3
    python -m company.news.platforms.tonghuashun 600519 --reports
    python -m company.news.platforms.tonghuashun --flash
    python -m company.news.platforms.tonghuashun --flash --stock 600519
    python -m company.news.platforms.tonghuashun --article 679277455
    python -m company.news.platforms.tonghuashun --article https://stock.10jqka.com.cn/20260825/c679277455.shtml
    python -m company.news.platforms.tonghuashun 600519 --all --json
"""
...
from company.news.platforms.tonghuashun.article import fetch_article
from company.news.platforms.tonghuashun.flash import fetch_flash, query_page as query_flash_page
from company.news.platforms.tonghuashun.news import fetch_news, query_page, search_news
from company.news.platforms.tonghuashun.notices import (
    CLASSIFIES,
    CLASSIFY_LABELS,
    download_notices,
    download_pdf,
...
from company.news.platforms.tonghuashun.reports import fetch_reports, query_page as query_report_page
...
def main() -> int:
    ...
    if args.article:
        ...
        if args.json:
            ...
            from company.news.platforms.tonghuashun._common import cli_print
