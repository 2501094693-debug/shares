...
token 优先读 ``XUEQIU_TOKEN`` / ``XUEQIU_COOKIES``，否则访问首页获取。
    ...
    python -m company.news.platforms.xueqiu 600519
    python -m company.news.platforms.xueqiu 贵州茅台 --days 7
    python -m company.news.platforms.xueqiu 600519 --notices --days 90
    python -m company.news.platforms.xueqiu 600519 --reports
    python -m company.news.platforms.xueqiu 600519 --discuss
    python -m company.news.platforms.xueqiu --flash
    python -m company.news.platforms.xueqiu --flash --stock 600519
    python -m company.news.platforms.xueqiu --column headline
    python -m company.news.platforms.xueqiu --search 茅台
    python -m company.news.platforms.xueqiu --article 123456789
    python -m company.news.platforms.xueqiu 600519 --all --json
"""
...
from company.news.platforms.xueqiu.article import fetch_article
from company.news.platforms.xueqiu.columns import (
    COLUMNS,
    COLUMN_LABELS,
    column_page_url,
    fetch_column_news,
...
from company.news.platforms.xueqiu.flash import fetch_flash, query_page as query_flash_page
from company.news.platforms.xueqiu.news import fetch_news, query_page, search_news
from company.news.platforms.xueqiu.notices import fetch_notices, query_page as query_notice_page
from company.news.platforms.xueqiu.reports import fetch_reports, query_page as query_report_page
...
def main() -> int:
    ...
    if args.article:
        ...
        if args.json:
            ...
            from company.news.platforms.xueqiu._common import cli_print
