...
东财没有文档化的公开新闻 API，以下全部是官网前端 XHR。
    ...
    python -m company.news.eastmoney 600519
    python -m company.news.eastmoney 贵州茅台 --days 7 --strict
    python -m company.news.eastmoney 600519 --f10
    python -m company.news.eastmoney 600519 --notices --days 90
    python -m company.news.eastmoney 600519 --notices --download ./pdfs --limit 3
    python -m company.news.eastmoney --flash
    python -m company.news.eastmoney --flash --column listed --stock 600519
    python -m company.news.eastmoney --column breakfast
    python -m company.news.eastmoney --article 202608243851623734
    python -m company.news.eastmoney 600519 --all --json
"""
...
from company.news.eastmoney.article import fetch_article
from company.news.eastmoney.columns import (
...
from company.news.eastmoney.f10 import (
    fetch_f10,
    fetch_f10_news,
    fetch_f10_notices,
    query_page as query_f10_page,
)
from company.news.eastmoney.flash import (
...
from company.news.eastmoney.notices import (
    download_notices,
...
from company.news.eastmoney.search import (
    SCOPES,
    SORTS,
    TYPES,
    fetch_news,
...
def main() -> int:
    ...
    if args.article:
        ...
        if args.json:
            ...
            from company.news.eastmoney._common import cli_print
