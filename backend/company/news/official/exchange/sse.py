...
三套公开查询（均要带官网 Referer，否则 query.sse.com.cn 常 403）：
  ...
  3. commonSoaQuery.do           问询函 / 关注函 / 重组问询
    ...
    python company/news/exchange/sse.py 600519
    python company/news/exchange/sse.py 600519 --days 90
    python company/news/exchange/sse.py 600519 --category annual
    python company/news/exchange/sse.py 600519 --keyword 问询函
    python company/news/exchange/sse.py 600519 --inquiries
    python company/news/exchange/sse.py 688981 --category yearly --days 800
    python company/news/exchange/sse.py --latest --days 7 --limit 20
    python company/news/exchange/sse.py --latest --category annual --days 30
    python company/news/exchange/sse.py 600519 --download ./pdfs --limit 3
"""
