...
两套公开查询（JSON，需带官网 Referer）：
  ...
  2. /api/report/ShowReport/data        问询函 / 关注函（CATALOGID=main_wxhj）
    ...
    python company/news/exchange/szse.py 000001
    python company/news/exchange/szse.py 000001 --days 90
    python company/news/exchange/szse.py 000001 --category annual
    python company/news/exchange/szse.py 000001 --keyword 董事
    python company/news/exchange/szse.py 002731 --inquiries
    python company/news/exchange/szse.py 300750 --days 60
    python company/news/exchange/szse.py --latest --days 3 --limit 20
    python company/news/exchange/szse.py --latest --category annual --days 30
    python company/news/exchange/szse.py 000001 --download ./pdfs --limit 3
"""
